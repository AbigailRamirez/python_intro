...
# ====================================
# Function below allows the user to input a new recipe data
# (name, cooking time, ingredients) and 
# also automatically determines a difficulty level based on cooking time 
