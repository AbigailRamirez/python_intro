...
# calculate_difficulty() calculates the difficulty of the recipe by taking in cooking_time 
# and ingredients as arguments, 
# and assign the difficulty level as a strings: Easy, Medium, Intermediate, or Hard to the difficulty variable
...
# return_ingredients_as_list() function 
# retrieves the ingredients string inside Recipe object as a list
...
# ====================================
# Function below allows the user to input a new recipe data (name, cooking time, ingredients) 
# and also automatically determines a difficulty level based on cooking time 
...
def delete_recipe():
    ...
    if session.query(Recipe).count() == 0:
        ...
        print("results: ", results)
        print("Lists of available recipes:")
